...
class ExpenseReadRepository(ReadRepository[ExpenseReadModel]):
    ...
    def add(self, aggregate: ExpenseReadModel) -> Either[
        None,
    ...
    def remove(self, aggregate: ExpenseReadModel) -> Either[
        None,
        RepositoryUnexpectedError | ConcurrencyError | ConflictError,
    ]: ...
